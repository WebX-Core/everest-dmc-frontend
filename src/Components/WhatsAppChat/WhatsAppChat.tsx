...
const WhatsAppChat = () => {
  ...
  const handleRedirect = () => {
    window.open(
      "https://wa.me/9779801193375?text=Hello%20I%20want%20to%20know%20more%20about%20your%20services",
      "_blank"
    );
  };
  ...
  return (
    <>
      {/* Message bubble */}
      {showMessage && (
        <div className="fixed bottom-20 right-6 bg-white text-black px-4 py-3 rounded-xl shadow-lg z-[999999] md:z-50 w-64 transition-all duration-initial opacity-100 translate-y-0 transform animate-fadein">
          <div className="flex justify-between items-center gap-2">
            <div className="text-sm font-medium ">Message us on WhatsApp</div>
            <button
              className="text-zinc-500 text-lg font-bold cursor-pointer hover:text-blue-600 transition-transform duration-200"
