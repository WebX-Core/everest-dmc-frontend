...
const About = () => {
  return (
    <section
      id="about"
      className="relative bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 py-20 px-4 md:px-10 lg:px-20"
    >
            ...
            <div className="space-y-12">
              {points.map((item, index) => (
                ...
                >
                  ...
                  <div className="relative bg-white border border-white/20  p-8 hover:shadow-lg transition-all duration-500 group-hover:bg-white">
                    {/* Gradient border effect */}
                    <div
                      className={`absolute inset-0 bg-gradient-to-r ${item.color} rounded-2xl opacity-0 group-hover:opacity-20 transition-opacity duration-500 blur-xl`}
                    ></div>

                    {/* Number badge */}
                    <div
                      className={`absolute -top-6 -left-6 w-12 h-12  rounded-full flex items-center justify-center text-[#1C4D9B] font-bold text-4xl transform group-hover:scale-110 transition-transform duration-300`}
                    >
                      {item.number}
                    </div>
                    ...
                    {/* Hover effect lines */}
                    <div
                      className={`absolute bottom-0 left-0 h-1 bg-gradient-to-r ${item.color} rounded-b-2xl w-0 group-hover:w-full transition-all duration-500`}
                    ></div>
                  </div>
                </Motion.div>
              ))}
            ...
            <div className="lg:sticky lg:top-20 space-y-8">
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  >
                    About <span className="text-[#1C4D9B]">Everest DMC</span>
                  </Motion.h2>
                </div>
                ...
                >
                  <div className="bg-transparent backdrop-blur-sm border border-white/30 rounded-xl transition-all duration-300">
                    <p className="text-gray-700 text-xl leading-relaxed">
                      <span className="font-semibold text-[#1C4D9B]">
                        Everest DMC
                      </span>{" "}
                      is a trusted B2B destination management company in Nepal,
                      offering personalized travel, trekking, and MICE services
                      across the majestic Himalayas.
                    </p>
                    <p className="text-gray-700 text-xl leading-relaxed">
                      Since{" "}
                      ...
                      , we've provided unmatched local expertise, tailor-made
                      experiences, and 24/7 support for clients worldwide, all
                      while promoting responsible tourism and strong community
                      values.
                    </p>
                  </div>
                </Motion.div>
