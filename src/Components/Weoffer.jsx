          ...
          >
            ...
            {image.hasOverlay && (
              ...
              >
                ...
                <button className="px-4 py-2 bg-white text-[#1C4D9B] rounded-md font-medium hover:bg-opacity-90 transition">
                  Explore Now
                </button>
              </div>
            )}
...
//     <section
//       id="services"
//       className="relative bg-gradient-to-br from-blue-200 via-blue-50/30 to-indigo-50/50 py-16 px-4 md:px-10 lg:px-20 h-250"
//     >
//       {/* Background Elements */}
